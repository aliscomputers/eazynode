...
sleep 3
sudo wget https://raw.githubusercontent.com/aliscomputers/eazynode/master/eazyd -O /usr/local/bin/eazyd
sudo wget https://raw.githubusercontent.com/aliscomputers/eazynode/master/eazy-cli -O /usr/local/bin/eazy-cli
