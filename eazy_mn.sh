...
sleep 3
sudo wget https://raw.githubusercontent.com/aliscomputers/eazynode/master/eazyd-113.exe -O /usr/local/bin/eazyd
sudo wget https://raw.githubusercontent.com/aliscomputers/eazynode/master/eazy-cli-113.exe -O /usr/local/bin/eazy-cli
